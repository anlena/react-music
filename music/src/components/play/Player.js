...
class Player extends React.Component {
    ...
    componentDidUpdate(){
        // 兼容手机端canplay事件触发后第一次调用paly()方法无法自动播放的问题
    ...
    // 歌曲模式切换
    changePlayMode = () => {
        if(this.state.currentPlayModel === this.playModes.length - 1){
    ...
    render(){
        ...
        return(
            <div className="player-container">
                <CSSTransition in={this.props.showStatus} timeout={300} className="player-rotate"
                    onEnter = {() => {
                ...
                <div className="player" ref="player">
                        ...
                        <div className="controller-wrapper">
                            <div className="progress-wrapper">
                                ...
                                <div className="play-progress">
                                    <Progress  progress={this.state.playProgress} onDrag={this.handleDrag} onDragEnd={this.handleDragEnd}></Progress >
                                </div>
                    ...
                    <div className="player-bg" ref="playBg"></div>
               ...
               <MiniPlayer song={song} progress={this.state.playProgress} 
                                        ...
                                        showminiPlayer={this.showPlayer}></MiniPlayer>
            </div>
        )
    }
}
